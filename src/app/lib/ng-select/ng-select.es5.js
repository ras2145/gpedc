...
var Diacritics = /** @class */ (function () {
     ...
     * @return {?}
     */
    Diacritics.strip = function (text, disabled) {
      var _this = this;
      if(disabled)return '';
...
var OptionList = /** @class */ (function () {
    ...
    OptionList.prototype.filter = function (term) {
        ...
        if (term.trim() === '') {
            ...
            this.options.forEach(function (option) {
                var /** @type {?} */ l = Diacritics.strip(option.label, option.disabled).toUpperCase();
...
SelectDropdownComponent.decorators = [
    { type: Component, args: [{
                ...
                styles: ["\n      select-dropdown {\n        -webkit-box-sizing: border-box;\n                box-sizing: border-box; }\n        select-dropdown * {\n          -webkit-box-sizing: border-box;\n                  box-sizing: border-box; }\n        select-dropdown > div {\n          background-color: #fff;\n          border: 1px solid #ccc;\n          border-top: none;\n          -webkit-box-sizing: border-box;\n                  box-sizing: border-box;\n          position: absolute;\n          z-index: 1;  border-radius: 0px 0px 5px 5px !important;}\n          select-dropdown > div .filter {\n            padding: 3px;\n            width: 100%; }\n            select-dropdown > div .filter input {\n              border: 1px solid #eee;\n              -webkit-box-sizing: border-box;\n                      box-sizing: border-box;\n              padding: 4px;\n              width: 100%; }\n          select-dropdown > div .options {\n            max-height: 408px;\n            overflow-y: auto;\n      padding-bottom: 5px;}\n            select-dropdown > div .options ul {\n              list-style: none;\n              margin: 0;\n              padding: 0; }\n              select-dropdown > div .options ul li {\n                padding: 4px 8px;\n                cursor: pointer;\n                -webkit-user-select: none;\n                   -moz-user-select: none;\n                    -ms-user-select: none;\n                        user-select: none; }\n        select-dropdown .selected {\n          background-color: #e0e0e0; }\n          select-dropdown .selected.highlighted {\n            background-color: #2196F3;\n            color: #fff; }\n        select-dropdown .highlighted {\n          background-color: #2196F3;\n          color: #fff; }\n        select-dropdown .disabled {\n      font-weight: bold;\n    background-color: #fff;\n          color: #e27e53 !important;\n          cursor: default;\n          pointer-events: none; }\n    "], //edit this line for change styles (lo siento Ross :V )
                encapsulation: ViewEncapsulation.None
            },] },
];
/**
